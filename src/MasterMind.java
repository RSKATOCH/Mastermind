...
public class MasterMind {
	...
	public static void main(String[] args) throws NumberFormatException, Exception {
		...
		do{
			...
			if(difficultyLevel.equalsIgnoreCase("E")) game.getWordSet(MasterMind.EASY);
			if(difficultyLevel.equalsIgnoreCase("M")) game.getWordSet(MasterMind.MEDIUM);
			if(difficultyLevel.equalsIgnoreCase("H")) game.getWordSet(MasterMind.HARD);
